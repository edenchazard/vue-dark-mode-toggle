...
const As = /* @__PURE__ */ mt(Rs, [["render", Fs]]), js = (e) => (Ar("data-v-5e2e086a"), e = e(), jr(), e), zs = /* @__PURE__ */ js(() => /* @__PURE__ */ Z("span", { class: "dark-mode-bg" }, null, -1)), Ks = { class: "dark-mode-rotate" }, Hs = /* @__PURE__ */ qr({
  __name: "VueDarkModeToggle",
  props: {
    darkModeEnabled: { type: Boolean, default: !1 },
    as: { default: "span" }
  },
  setup(e) {
    const t = e;
    ...
    return Jr(() => {
      ...
      class: De(["dark-mode-toggle", { night: s.darkModeEnabled }]),
...
const Us = /* @__PURE__ */ mt(Hs, [["__scopeId", "data-v-5e2e086a"]]), At = {
  applyTo: "html",
...
function Ls(e = At) {
  const t = st({
    ...
    get() {
      if (n.value === void 0) {
        ...
        c === null ? n.value = (window == null ? void 0 : window.matchMedia("(prefers-color-scheme: dark)").matches) ?? t.defaultValue : n.value = c === "true";
      }
      return r(), n.value;
    },
    set(c) {
  ...
  function r() {
    if (!t.applyTo)
      return;
    let c = null;
    t.applyTo instanceof HTMLElement ? c = t.applyTo : typeof t.applyTo == "string" && (c = document.querySelector(t.applyTo)), c == null || c.classList[n.value ? "add" : "remove"](t.className);
  }
  function o() {
    s.value = !s.value;
  }
